...
unsafe fn capitanfalcon_specialn(agent: &mut L2CAgentBase) {
...
#[acmd_script( agent = "captain", script = "effect_specialn", category = ACMD_EFFECT, low_priority )]
unsafe fn capitanfalcon_specialn_fx(agent: &mut L2CAgentBase) {
...
pub fn install() {
    smashline::install_acmd_scripts!(
        capitanfalcon_specialn,
        capitanfalcon_specialn_fx
    );
}

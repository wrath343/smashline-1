...
unsafe fn capitanfalcon_specialnturn(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        ...
        macros::ATTACK(agent,  /*do not edit*/
            ...
            28.0,  /*damage*/ //Original 28/
            20,   /*angle*/ //Original 361/
            65, 0, 85,   /*kgb, fkb, bkb*/ //Original 65,  0, 85, /
            5.0,  /*size*/ //Original 4.5 /
            ...
            *COLLISION_PART_MASK_ALL,  /*collision part*/ 
            //Hash40::new("collision_attr_fire"),  /*effect*/
            false, Hash40::new("collision_attr_purple"),  /*friendly fire*/
            *ATTACK_SOUND_LEVEL_L,  /*sfx level*/
            *COLLISION_SOUND_ATTR_KICK,  /*sfx type*/
            *ATTACK_REGION_PUNCH); /*type*/
...
#[acmd_script( agent = "captain", script = "effect_specialnturn", category = ACMD_GAME, low_priority )]
unsafe fn capitanfalcon_specialnturn_fx(agent: &mut L2CAgentBase) {
...
pub fn install() {
    smashline::install_acmd_scripts!(
        capitanfalcon_specialnturn,
        capitanfalcon_specialnturn_fx
    );
}
